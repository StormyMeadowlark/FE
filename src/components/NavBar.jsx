        ...
        <header className="px-3">
          ...
          >
            <div className=" ">
              <Link
                to="/"
                className="flex flex-1 focus:outline focus:outline-[#00FF00]">
                <span className="sr-only">H.E.M Automotive</span>
                <Logo className="m-2 scale-75 hover:scale-[70%] hover:brightness-90 active:scale-[65%] active:brightness-[80%]" />
              </Link>
            </div>
            <div>
              <ContactInfo />
