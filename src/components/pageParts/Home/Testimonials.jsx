...
function Testimonials() {
    return(
        <div className="relative flex flex-col py-20 bg-[#333333] px-20">
            <div className="relative mx-auto max-w-7xl">
                <div className="justify-center pb-10 ">
                    ...
                    <span className="text-stroke text-stroke-fill-black text-stroke-[#00ff00]">The High-End Mechanic Difference</span></h3>
                    <p className="max-w-3xl text-xl text-[#dddddd] font-Urbanist tracking-wider">
