...
function Testimonials() {
    return(
        <div className="relative flex flex-col lg:py-20 py-8 bg-[#333333] px-10 text-wrap">
            <div className="relative mx-auto max-w-7xl">
                <div className="justify-center pb-4 md:pb-4">
                    <h3 className="lg:text-6xl text-stroke-black text-stroke text-stroke-fill-white text-4xl md:text-5xl uppercase  font-Bungee">Experience<br />
