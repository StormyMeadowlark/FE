            ...
            <ul className="px-10 font-Play text-xl tracking-wider">
              <li className="pt-8">
                ...
                <p>
                  ...
                  vehicles. At HEM Automotive we gather & process information
                  from visitors both in-person & online. Your privacy is of
                  upmost importance to us, therefore, this policy has been put
                  in place to outline the terms & condition regarding the
                  various types of information we collect, how that information
                  is used and protected, and how you can gain access to and edit
                  data we have collected about you at any time. By using our
                  services both in-person & online, you consent to the practices
                  described in this policy and all other HEM Automotive
                  documentation referred to within.
                </p>
                <p>
              ...
              <li className="pt-8">
                ...
                <p>
                  ...
                  to your full name, street address, mailing address, email
                  address, phone number, payment information, payment
                  information, vehicle information, including, location data and
                  velocity depending on services requested. Voluntarily given
                  personal information is used to help us understand and respond
              ...
              <li className="pt-8">
                ...
                <p>
                  ...
                  third parties, other than as described below, and never
...
<h5 className="text-xl font-bold pb-4 text-[#00ff00]">Data processing agreement</h5>
...
<h5 className="text-xl font-bold pb-4 text-[#00ff00]">Server log files</h5>
...
<li>A universally unique identifier (UUID) of the website visitor that clicked the cookie banner</li>
              ...
              <li className="pt-8">
                ...
                <p>
                  ...
                  improve the site and our services. Google Analytics collects
                  the IP address assigned to you on the date you visit sites,
              ...
              <li className="pt-8">
                ...
                <p>
                  ...
                  sites. We highly recommend your read the privacy policy of any
                  site you visit, even the linked ones. Nonetheless, we seek to
              ...
              <li className="pt-8">
                ...
                <p>
                  ...
                  information HEM Automotive will remove and destroy all
                  information.
                </p>
              </li>
              <li className="pt-8">
                ...
                <p>
                  ...
                  travel through servers located in the United States. Any data
                  provided will be kept on servers within the United States.
                </p>
              </li>
              <li className="pt-8">
                ...
                <p>
                  ...
                  record password associated with it. We kindly ask you not to
              ...
              <li className="pt-8">
                ...
                <p>
                  ...
                  information. As a user of HEM Automotive you should use
                  caution when deciding to provide your personal information in
                  these areas.
                </p>
              </li>
              <li className="pt-8">
                ...
                <p>
                  ...
                  These measures include encryption, firewalls, and secure
                  access controls. If for some reason there is a breach in the
                  security to our personal data, we will notify those affected
              ...
              <li className="pt-8">
                ...
                <p>
                  ...
                  HEM Automotive please contact us at the location listed below
                  or within the correspondence itself.
                </p>
              </li>
              <li className="pt-8">
                ...
                <p>
                  ...
                  legal claims, enforce policies, or have an account open with
                  us. Retention periods are determined by the type of
                  information and the purpose of collection. Outdated, unused
                  information will be removed and destroyed. We may edit, add to
                  or remove incomplete and inaccurate information at any time as
                  HEM Automotive see fit to do so, keeping in mind our legal
                  obligations.
                </p>
              </li>
              <li className="pt-8">
                ...
                <p>
                  ...
                  by posting the new Privacy Policy on our website. Your
              ...
              <li className="pt-8">
                ...
                <p>Email: privacypolicy@hemautomotive.com</p>
                <br />
                <p className="pb-10">
